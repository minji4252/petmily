  ...
  createButton.addEventListener("click", () => {
    ...
    if (inputBoxValue !== "") {
      document.querySelector(".to-do-list").innerHTML += `
          <li class="todo-right-box">
            <div class="todo-right-detail-left">
            <svg
            type="checkbox"
            id="checkbox"
            class="todo-right-detail-left-icon-empty"
          ...
          <svg
            type="checkbox"
            id="checkbox"
            class="todo-right-detail-left-icon"
            xmlns="http://www.w3.org/2000/svg"
            width="24"
            height="24"
            viewBox="0 0 25 26"
          ...
          >
            ...
            <div class="todo-right-detail-right">
              <svg
                class="todo-right-detail-right-modify"
                xmlns="http://www.w3.org/2000/svg"
                width="24"
                height="24"
                viewBox="0 0 28 26"
              ...
              <svg
                ...
                class="todo-right-detail-right-delete"
                xmlns="http://www.w3.org/2000/svg"
                width="18"
                height="18"
                viewBox="0 0 15 16"
